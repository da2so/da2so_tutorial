...
class Trainer:
    ...
    def test(self, epoch):
        ...
        def test_loop(test_loss, correct, total):
        ...
        if self.ng:
            with torch.no_grad():
                test_loop(test_loss, correct, total)
        else:
            test_loop(test_loss, correct, total)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--no_grad', default=True, type=bool, help='use no grad in validation')
