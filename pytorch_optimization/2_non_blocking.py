...
class Trainer:
    ...
    def train(self, epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            inputs, targets = inputs.to(self.device, non_blocking=self.non_blocking), targets.to(self.device, non_blocking=self.non_blocking)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--non_blocking', default=True, type=bool, help='non blocking for data transfer')
