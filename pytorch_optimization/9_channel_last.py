...
class Trainer:
    ...
    def train(self, epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            ...
            if self.cl:
                inputs, targets = inputs.to(self.device, memory_format=torch.channels_last), targets.to(self.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--channel_last', default=True, type=bool, help='use channel last')
    ...
    for m in model:
        for cl in channel_last:
            args.channel_last = cl
